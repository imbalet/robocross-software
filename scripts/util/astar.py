...
class AstarGrid:
    ...
    def __init__(self, arr: np.ndarray, path_discrete):
        ...
        self.neighbours = [
            ...
            (0, path_discrete, 1),
            (0, -path_discrete, 1),
            (path_discrete, path_discrete, 1.4),
            (path_discrete, -path_discrete, 1.4),
            (-path_discrete, path_discrete, 1.4),
            (-path_discrete, -path_discrete, 1.4),
        ]
    ...
    def get_neighbours(self, node):
        ...
        for x, y, p_w in self.neighbours:
            neighbour = [node[0] + int(x), node[1] + int(y)]
            try:
    ...
    def get_path(self, grid, start_pos, goal_pos):
        ...
        while True:
            ...
            for neighbour in neighbours:
                ...
                if (grid_weight == self.non_walkable_weight or grid.closed[y, x] or
                        not self.check_collision(grid, neighbour, self.robotRad)):
                    pass
                else:
